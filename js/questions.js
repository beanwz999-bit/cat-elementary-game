...
export const BOSS_QUESTIONS = [
  ...
  { text: "What is 12 x 12?", options: ["124", "144", "154", "164"], correct: "144" },
  { text: "What is 150 - 75?", options: ["50", "65", "75", "85"], correct: "75" },
  { text: "What is 99 + 99?", options: ["188", "198", "208", "218"], correct: "198" },
  { text: "Solve for x: 5x = 45", options: ["7", "8", "9", "10"], correct: "9" },
  { text: "What is 1/4 of 100?", options: ["20", "25", "30", "50"], correct: "25" },
  { text: "What is 72 / 8?", options: ["7", "8", "9", "10"], correct: "9" },
  { text: "Which word is a verb? 'The cat chased a small mouse.'", options: ["cat", "chased", "small", "mouse"], correct: "chased" },
  { text: "Find the plural form of 'mouse':", options: ["mouses", "mice", "meece", "mices"], correct: "mice" },
  { text: "Which word means 'very tired'?", options: ["excited", "exhausted", "furious", "hungry"], correct: "exhausted" },
  { text: "What is the opposite of 'Ancient'?", options: ["Old", "Modern", "Heavy", "Strong"], correct: "Modern" },
  { text: "Which planet is closest to the Sun?", options: ["Earth", "Mars", "Venus", "Mercury"], correct: "Mercury" },
  { text: "What is the natural satellite of the Earth?", options: ["Sun", "Moon", "Mars", "Jupiter"], correct: "Moon" },
  { text: "What is the largest mammal on Earth?", options: ["African Elephant", "Blue Whale", "Giraffe", "Grizzly Bear"], correct: "Blue Whale" },
  { text: "How many legs does a spider have?", options: ["6", "8", "10", "12"], correct: "8" },
  { text: "Water turns into steam when it is:", options: ["Frozen", "Cooled", "Heated", "Shaken"], correct: "Heated" },
  { text: "What is the main source of light for Earth?", options: ["Moon", "Sun", "Stars", "Fireflies"], correct: "Sun" },
  { text: "Which animal is known as a feline?", options: ["Dog", "Cat", "Lion", "Tiger"], correct: "Cat" },
  { text: "Spell the missing letters: L - I - __ - __ - A - R - Y", options: ["B, R", "P, R", "B, E", "D, R"], correct: "B, R" }
];
